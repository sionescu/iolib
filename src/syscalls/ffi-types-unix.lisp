...
;; Other signals
(constant (sigemt    "SIGEMT") :optional t)
(constant (sigio     "SIGIO"))
(constant (sigcld    "SIGCLD") :optional t)
(constant (sigpwr    "SIGPWR") :optional t)
(constant (siginfo   "SIGINFO") :optional t)
(constant (siglost   "SIGLOST") :optional t)
